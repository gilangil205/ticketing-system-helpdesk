                    ...
                    <form method="POST" action="{{ route('employees.update', $employee->id) }}" enctype="multipart/form-data" class="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex flex-col items-center space-y-4">
                                            <div class="relative group">
                                                <img id="photoPreview"
                                                     src="{{ $employee->profile_photo ? asset('storage/'.$employee->profile_photo) : 'https://via.placeholder.com/128?text=No+Photo' }}" 
                                                     alt="Profile Photo" 
                                            ...
                                            <div class="space-y-1 text-center">
                                                ...
                                                <div class="flex text-sm text-gray-600">
                                                    <label for="profile_photo" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none">
                                                        ...
                                                        <input id="profile_photo" name="profile_photo" type="file" accept="image/*" class="sr-only" onchange="previewPhoto(event)">
                                                    </label>
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="role" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300 text-sm" required>
                                    ...
                                    <div>
                                        ...
                                        <select name="status" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300 text-sm" required>
                        ...
                        <div class="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-6">
                            <a href="{{ route('employees.index') }}" 
                               class="inline-flex justify-center items-center px-4 py-2 bg-gray-200 rounded-md text-gray-700 hover:bg-gray-300 text-sm">
                                Cancel
                            </a>
                            <button type="submit" 
                                    class="inline-flex justify-center items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-sm">
                                Update Employee
                            </button>
                        </div>
                    </form>
